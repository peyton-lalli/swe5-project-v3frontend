...
<script>
  ...
  import EventRepertoireSelectionBody from "../Events/EventRepertoireSelectionBody.vue";
    ...
    data() {
      return {
        ...
        timesInfoString: JSON.parse(JSON.stringify(this.sentSignupEventData))
          .timesInfoString,
        selectedTimeslot: { id: 3, time: "09:20:00" },
        ...
        selectedEventSongs: JSON.parse(JSON.stringify(this.sentSignupData))
          .songs,
        selectedInstructor: "Nathan Lalli",
        selectedInstructorAvailability: [],
        selectedAccompanist: "Peyton Lalli",
        ...
        if (Object.keys(this.selectedTimeslot).length === 0) {
          ...
          if (this.isEdit) {
            let data = {
              ...
              studentId: 2, //this.userStore.userRoleInfo.studentId,
            };
